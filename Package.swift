...
let version: Version = "11.20.0-SNAPSHOT-02-16--18-11.git-acccfdf"
let checksum = "4db49c4a71598d959db2f1d5618e10f85a71ddb73054bea8cbbc1f7c4982a7fe"
...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MapboxMaps",
            url: "https://api.mapbox.com/downloads/v2/mobile-maps-ios/snapshots/ios/\(version)/MapboxMaps.zip",
            checksum: checksum
        )
    ]
)
